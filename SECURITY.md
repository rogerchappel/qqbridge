...
Replace this section with the supported versions for `qqbridge`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `qqbridge` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in qqbridge.
